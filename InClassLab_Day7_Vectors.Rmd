...
```{r}
dice_roll_15 <- function(name1, name2){
  prob_roll <- c(rep(1/6, 6))
  roll_15 <- function(){
    sample(1:6, 15, replace = T, prob = prob_roll)
  }
  ...
  print(paste(name1, "wins", p1_wins, "times", sep = " "))
  print(paste(name2, "wins", p2_wins, "times", sep = " "))
  print(paste(name1, "and", name2, "tie", ties, "times", sep = " "))
...
roll_weighted_die <- function(name1, name2){
  
  die_prob1 <- c(rep(0.2, 3), 0.5, 0.6, 0.7)
  die_prob2 <- c(rep(1/6, 6))
  
  roll1 <- sample(1:6, 15, replace = T, prob = die_prob1)
  roll2 <- sample(1:6, 15, replace = T, prob = die_prob2)
...
weighted_winner <- roll_weighted_die("Bob", "Boopy")

"The second person only won 1/10 of the times."
```
